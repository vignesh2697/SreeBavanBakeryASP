<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Customers.aspx.cs" Inherits="Bakery.Customers" %>
...
<body>
    <form id="form1" method="post" runat="server" name="contact-us" action="Customers.aspx">
                        ...
                        <ul class="navbar-nav d-flex justify-content-around">
                            <li class="d-flex flex-lg-row flex-column">
                                ...
                                <div class="nav-item active">
                                    <a class="nav-link" href="Customers.aspx">Customers<span class="sr-only">(current)</span></a>
                                </div>
                                <div class="nav-item">
                        ...
                        <div class="section-content bg-white p-5 shadow">
                            ...
                            <div class="row align-items-center">
                                <div class="col-md-3 form-group">
                                    <asp:Label ID="Label1" runat="server" Text="Customer Name:" Font-Bold="True" ForeColor="Black" Font-Size="Medium"></asp:Label>
                                    <asp:TextBox ID="txt_customerName" runat="server" placeholder="Enter Customer Name" CssClass="form-control"></asp:TextBox>
                                </div>
                                <div class="col-md-3 form-group">
                                ...
                                <div class="col-md-6 text-center btn-group-sm">
                                    <asp:Button ID="btn_saveCus" runat="server" Text="Save" CssClass="btn btn-primary btn-shadow btn-lg" type="submit" OnClick="btn_saveCus_Click" />
                                    <asp:Button ID="btn_deleteCus" runat="server" Text="Delete" CssClass="btn btn-warning btn-shadow" type="submit" OnClick="btn_deleteCus_Click" />
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-12">
                                    <asp:GridView ID="GridView" runat="server"
                                        ...
                                        PagerSettings-NextPageText="&gt;" Font-Size="10pt" AutoGenerateColumns="False" OnRowCommand="GridView_RowCommand">
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="Mobile Number" HeaderText="Mobile Number" ReadOnly="True" />
                                        </Columns>
                                    </asp:GridView>
                                </div>
                            </div>
