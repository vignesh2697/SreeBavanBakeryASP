<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Category.aspx.cs" Inherits="Bakery.Category" %>
...
<body>
    <form id="form1" method="post" runat="server" name="contact-us" action="Category.aspx">
                        ...
                        <div class="section-content bg-white p-5 shadow">
                            ...
                            <div class="row">
                                <div class="col-md-12 form-group">
                                    <asp:Label ID="Label1" runat="server" Text="Category Name:" Font-Bold="True" ForeColor="Black" Font-Size="Medium"></asp:Label>
                                    <asp:TextBox ID="txt_categoryName" CssClass="form-control" placeholder="Enter Category Name" runat="server" />
                                </div>
                            </div>
                            <div class="row align-items-center">
                                <div class="col-md-12 text-center btn-group-sm">
                                    <asp:Button ID="btn_saveCate" CssClass="btn btn-primary btn-shadow btn-lg" Text="Save" runat="server" OnClick="btn_saveCate_Click" />
                                    <asp:Button ID="btn_deleteCate" CssClass="btn btn-warning btn-shadow" Text="Delete" runat="server" OnClick="btn_deleteCate_Click" />
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-12">
                                    <asp:GridView ID="dgv_categoryList" runat="server" AutoGenerateColumns="False"
                                        ...
                                        Font-Size="10pt" OnSelectedIndexChanged="dgv_categoryList_SelectedIndexChanged" DataKeyNames="id">
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="name" HeaderText="Category Name" ReadOnly="True" />
                                        </Columns>
                                    </asp:GridView>
                                </div>
                            </div>
